...
class OpenBridgeView extends GetView<DeteksiController> {
            ...
            child: Column(
              children: [
                ...
                if (!isInitialized) ...[
                  ...
                  _cameraPreview(screenWidth, cameraHeight),
                  const SizedBox(height: 16),
                  _predictionBox(),
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text(
                'Open Bridge adalah teknik standar yang digunakan untuk pukulan lurus dan kontrol bola yang konsisten. '
                'Telapak tangan menyentuh meja dengan jari terbuka.',
  ...
  Widget _cameraPreview(double width, double height) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16),
      child: Container(
        width: width,
