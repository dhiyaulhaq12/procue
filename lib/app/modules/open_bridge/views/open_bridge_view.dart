...
class OpenBridgeView extends StatelessWidget {
            ...
            const Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Open Bridge adalah teknik standar yang digunakan untuk pukulan lurus dan kontrol bola yang konsisten. Telapak tangan menyentuh meja dengan jari terbuka.',
                    style: TextStyle(
                      fontSize: 16,
          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                '2. Posisikan tangan sesuai teknik Open Bridge\n'
  ...
  Widget _predictionBox(PoseDetectionController controller) {
    return Obx(() {
      ...
      final isCorrect = label == 'OpenBridge';
                ...
                Expanded(
                  child: Text(
                    isCorrect
                        ...
                        : 'Posisikan tangan Anda untuk Open Bridge',
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                      color: isCorrect
